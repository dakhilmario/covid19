...
/* themes/covid/templates/navigation/menu-local-tasks.html.twig */
class __TwigTemplate_f16a916264b057708a2f848ef667ac8f7e2d6f7e179f1eaa532f3c2ec1c359d0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/covid/templates/navigation/menu-local-tasks.html.twig";
    }
...
{% if primary %}
  ...
  <ul class=\"menu-local-tasks\">{{ primary }}</ul>
{% endif %}
{% if secondary %}
  <h2 class=\"visually-hidden\">{{ 'Secondary tabs'|t }}</h2>
  <ul>{{ secondary }}</ul>
{% endif %}
", "themes/covid/templates/navigation/menu-local-tasks.html.twig", "C:\\wamp64\\www\\project3\\covid19\\themes\\covid\\templates\\navigation\\menu-local-tasks.html.twig");
    }
